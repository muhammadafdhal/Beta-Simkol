                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/profil/{{$profil->id}}/save" class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Masukan Username Anda." name="username"
                                        value="{{Auth::user()->username}}" class="form-control form-control-line" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Email</label>
                                <div class="col-md-12">
                                <input type="email" placeholder="Masukan Email Anda." value="{{Auth::user()->email}}" name="email"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" placeholder="Masukan Password Lama Anda." name="current_password" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Password Baru</label>
                                <div class="col-md-12">
                                    <input type="password" placeholder="Masukan Password Anda." name="new_password" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Konfirmasi Password</label>
                                <div class="col-md-12">
                                    <input type="password" name="new_confirm_password" placeholder="Masukkan sekali lagi password baru Anda." class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">No. Telepon</label>
                                <div class="col-md-12">
                                <input type="text" placeholder="Masukan No. Anda" name="us_tlp" value="{{Auth::user()->us_tlp}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Masukan Alamat Anda." name="us_alamat"
                                        value="{{Auth::user()->us_alamat}}" class="form-control form-control-line" required>
                                </div>
                            </div>
