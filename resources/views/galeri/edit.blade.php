...
<div class="col-sm-12">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form" action="{{route('materi.update', $materi->mt_id)}}" method="POST">
                @csrf
                <input type="hidden" name="_method" value="PATCH">
                <div class="form-group m-t-40 row">
                    <label for="example-text-input" class="col-2 col-form-label">Judul</label>
                    <div class="col-10">
                    <input class="form-control" type="text" value="{{$materi->mt_judul}}" placeholder="Judul" name="mt_judul"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        ...
                        <select class="custom-select col-12" name="mt_gr_id" id="inlineFormCustomSelect">
                            ...
                            @foreach ($user as $t)
                            <option value="{{$t->id}}"<?php if($materi->mt_gr_id==$t->id) { echo"selected";} ?>>{{$t->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" value="{{$materi->mt_materi}}" placeholder="Materi" name="mt_materi"
